  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      const updateData: any = {
        ...
        completion_comment: data.completion_comment.trim() || null,
        completion_jira_ticket: data.completion_jira_ticket.trim() || null,
      }
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="Add notes about the test run completion or failure details..."
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="e.g., PROJ-123 or full Jira URL"
            />
          </div>
            ...
            <div>
              ...
              {failureReasons.length === 0 && (
                <p className="text-sm text-gray-500 mt-1">
                  No failure reasons available. Add them in Settings → Failure Reasons.
                </p>
              )}
            </div>
          )}
